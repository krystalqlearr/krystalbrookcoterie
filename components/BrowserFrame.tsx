...
/**
 * Minimal browser chrome for presenting site screenshots. A restrained DEEP-RIVER
 * frame — muted dots + a quiet address pill — so a light site UI (and real
 * screenshots) pop against the milk canvas and read as "a website we built."
...
export default function BrowserFrame({ url = "glowtoure.com", children, className = "" }: Props) {
  return (
    <div className={`overflow-hidden border border-ink/15 bg-river ${className}`}>
