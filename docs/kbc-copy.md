...
| 16.31 | case study · deliverable | The system was written down, not just built — nine locked colours, four faces with one job each, and the governance that keeps a tenth colour from quietly appearing eighteen months in. · **Open the Glowtoure brand system ↗** | under Scope on /work/glowtoure (2026-09-10), linking the published brand book. Every figure in the line is one the document itself states; it opens in a new tab | (keep) |
