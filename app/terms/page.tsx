        ...
        <div className="max-w-measure space-y-10">
          ...
          {SECTIONS.map((s) => (
            <div key={s.h} className="border-t border-ink/12 pt-6">
              <h2 className="font-display text-fluid-xl font-normal text-ink">{s.h}</h2>
              <p className="mt-3 font-sans text-fluid-base leading-relaxed text-ink/70">{s.p}</p>
            </div>
          ))}
          <p className="border-t border-ink/12 pt-6 font-sans text-xs font-semibold uppercase tracking-[0.13em] text-ink/70">
